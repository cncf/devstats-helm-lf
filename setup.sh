...
"${1}h.sh" install mini-devstats-grafanas ./devstats-helm --set skipSecrets=1,skipPVs=1,skipBootstrap=1,skipProvisions=1,skipCrons=1,skipServices=1,skipNamespace=1,indexGrafanasTo=4
"${1}h.sh" install mini-devstats-services ./devstats-helm --set skipSecrets=1,skipPVs=1,skipBootstrap=1,skipProvisions=1,skipCrons=1,skipGrafanas=1,skipNamespace=1,indexServicesTo=4
